    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, projectsService.getAllProjects()];
                case 1:
                    projects = _a.sent();
                    return [2 /*return*/, res.status(httpStatus.OK).send(projects.rows)];
                case 2:
                    error_1 = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, projectsService.getProject(Number(projectId))];
                case 2:
                    project = _a.sent();
...
function createProject(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var projectParams, project, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, projectsService.createProject(projectParams)];
                case 2:
                    project = _a.sent();
                    return [2 /*return*/, res.status(httpStatus.CREATED).send(project.rows[0])];
                case 3:
                    error_3 = _a.sent();
                    if (error_3.name === "DuplicatedNameError") {
                        return [2 /*return*/, res.status(httpStatus.CONFLICT).send(error_3)];
                    }
...
function updateProject(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var projectParams, projectId, project, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    projectParams = req.body;
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, projectsService.updateProject(projectParams, Number(projectId))];
                case 2:
                    project = _a.sent();
                    return [2 /*return*/, res.status(httpStatus.OK).send(project.rows[0])];
                case 3:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, projectsService.deleteProject(Number(projectId))];
                case 2:
                    project = _a.sent();
                    return [2 /*return*/, res.status(httpStatus.OK).send(project.rows[0])];
                case 3:
